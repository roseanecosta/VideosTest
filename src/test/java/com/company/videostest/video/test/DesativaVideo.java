...
public class DesativaVideo {
    ...
    public void ativaVideo() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//select/option[@value='deactivate']")).click();
        driver.findElement(By.id("bash-action")).sendKeys(Keys.ENTER);
        assertEquals("Video -", driver.findElement(By.className("icon-14-video-gray")).getText());
    }
